            ...
            children: [
              ...
              Align(
                alignment: AlignmentDirectional.centerEnd,
                  child: TextButton(onPressed: (){}, child: Text("Forget Password?",style: GoogleFonts.roboto(
                    fontSize: 13,
          ...
          content: Column(
            mainAxisAlignment: MainAxisAlignment.center,
              ...
              children:[
                ...
                Text("Skin Scope",style: GoogleFonts.roboto(
                  fontSize: 32,
                ...
                Row(
                  children: [
                    ...
                    Text("Don't forget that skin scope is not a",style: GoogleFonts.montserrat(
                ...
                Padding(
                  ...
                  child: Align(
                    ...
                    child: Text("doctor replacement",style: GoogleFonts.montserrat(
                      color:const Color(0xFF2B3B48),
                      fontSize: 12,
                      fontWeight: FontWeight.w300,
                ...
                Row(
                  children: [
                    const Image(image: AssetImage("images/6.png")),
                    const SizedBox(width: 5,),
                    Text("The app help you diagnose your skin ",style: GoogleFonts.montserrat(
                      color:const Color(0xFF2B3B48),
                      fontSize: 12,
                      fontWeight: FontWeight.w300,
                ...
                Padding(
                  ...
                  child: Align(
                    alignment: Alignment.centerLeft,
                    child: Text(" but still need a doctor to get the right help.",style: GoogleFonts.montserrat(
                      color:const Color(0xFF2B3B48),
                      fontSize: 12,
                      fontWeight: FontWeight.w300,
                ...
                Row(
                  children: [
                    const Image(image: AssetImage("images/6.png")),
                    const SizedBox(width: 5,),
                    Text("Always remember early diction save life .",style: GoogleFonts.montserrat(
                      color:const Color(0xFF2B3B48),
                      fontSize: 12,
                      fontWeight: FontWeight.w300,
